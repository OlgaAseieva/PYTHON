    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('itle', models.CharField(db_index=True, max_length=50, unique=True)),
                ('descript', models.TextField(max_length=500)),
                ('is_visible', models.BooleanField(default=False)),
                ('photo', models.ImageField(upload_to=app1.models.AboutUs.get_file_name)),
            ],
            options={
                'ordering': ('is_visible',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_visible', models.BooleanField(default=False)),
                ('photo', models.ImageField(upload_to=app1.models.Event.get_file_name)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(upload_to=app1.models.Galery.get_file_name)),
                ('descript', models.CharField(max_length=300)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_visible', models.BooleanField(default=True)),
                ('photo', models.ImageField(upload_to=app1.models.Menu.get_file_name)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.menu')),
            ],
        ),
    ]
